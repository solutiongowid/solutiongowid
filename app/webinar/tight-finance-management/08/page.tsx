...
export default function TightFinanceManagement08Page() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const submitData = {
        ...
        webinar_type: 'tight-finance-management-08',
      ...
      window.location.href = '/webinar/tight-finance-management/08/thank-you';
    } catch (error) {
            ...
            <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
              <div style={{ marginBottom: '1.5rem' }}>
                <span className="badge" style={{ fontSize: '0.875rem', padding: '0.5rem 1.25rem', background: accentLight, color: accentDark, border: `1px solid ${accentBorder}` }}>
                  8월 20일 (목) 오전 11:00 – 12:00 | 온라인 ZOOM
                </span>
              </div>
              ...
              <div style={{ maxWidth: '600px', margin: '0 auto' }}>
                <Image
                  src="/tight-finance-management-08-thumbnail.png"
            ...
            <div style={{ maxWidth: '640px', margin: '0 auto' }}>
              ...
              <div style={{ background: '#fff', border: `1px solid ${accentBorder}`, borderRadius: '1rem', padding: '2rem 2.25rem' }}>
                {[
                  ...
                  { label: '일시', value: '8월 20일 (목) 오전 11:00 – 12:00' },
          ...
          <div className="report-container">
            <div style={{ maxWidth: '800px', margin: '0 auto' }}>
              ...
              <div className="cosmetic-timetable-pc" style={{ marginBottom: '3rem' }}>
                ...
                {[
                  { time: '11:00 ~ 11:25', session: '1부', title: '타이트 파이낸스', details: ['타이트 파이낸스가 무엇이고, 왜 지금 필요한가', '비용 집행 프로세스별 관리 방법 — 집행 전 · 집행 중 · 집행 후', '우리 회사의 고정비와 변동비를 확인하는 방법'] },
                  { time: '11:25 ~ 11:50', session: '2부', title: '재무팀의 시간을 줄여주는 지출관리 서비스 및 OPEN API', details: ['불필요한 시간을 줄이는 카드 발급과 한도 관리', '사내 비용 관리 정책 기반 서비스 설정', '복잡한 분석을 위한 OPEN API와 Claude 활용 방법'] },
                  { time: '11:50 ~ 12:00', title: 'Q&A' },
                ].map((item, i) => (
              ...
              <div className="cosmetic-timetable-mobile" style={{ marginBottom: '3rem' }}>
                {[
                  { time: '11:00 ~ 11:25', session: '1부', title: '타이트 파이낸스', details: ['타이트 파이낸스가 무엇이고, 왜 필요한가', '비용 집행 전 · 중 · 후 관리 방법', '고정비·변동비 확인 방법'] },
                  { time: '11:25 ~ 11:50', session: '2부', title: '지출관리 서비스 및 OPEN API', details: ['카드 발급과 한도 관리', '사내 비용 관리 정책 기반 서비스 설정', 'OPEN API와 Claude 활용 방법'] },
                  { time: '11:50 ~ 12:00', title: 'Q&A' },
                ].map((item, i) => (
          ...
          <div className="report-container">
            <div className="report-cta-content">
              <h3 className="report-h3" style={{ color: '#111' }}>
                <strong>돈이 새는 순간을 막는 법,<br />8/20 온라인 세미나에서 확인하세요</strong>
              </h3>
              <button
                onClick={openModal}
        ...
        <div className="modal-overlay" onClick={closeModal}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()} style={{ maxWidth: '560px', padding: 0 }}>
            ...
            <div className="modal-header">
              ...
              <p className="modal-description">8월 20일(목) 오전 11:00 – 12:00 | 온라인 ZOOM</p>
            </div>
