...
export default function AiSaasLeadFormThankYouPage() {
  useEffect(() => {
    if (typeof window.fbq === 'function') {
      window.fbq('track', 'Lead', {
        content_name: 'lead-form-ai-saas',
        content_category: 'ai-saas-report',
      });
    }
  }, []);
  ...
  return (
    <div className="report-page">
      ...
      <main className="thank-you-main" style={{ background: 'linear-gradient(135deg, #f0f6ff 0%, #ffffff 100%)' }}>
        <div className="report-container">
