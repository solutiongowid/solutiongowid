...
export default function ITConsultingThankYouPage() {
  useEffect(() => {
    if (typeof window.fbq === 'function') {
      window.fbq('track', 'Lead', {
        content_name: 'lead-form-it-consulting',
        content_category: 'it-consulting',
      });
    }
        ...
        <div className="report-container">
          <div className="thank-you-content">
            ...
            <p className="thank-you-description">
              담당자가 입력하신 이메일 주소로<br />
              예상 절감액과 확정 견적서를 안내드립니다.
            </p>
