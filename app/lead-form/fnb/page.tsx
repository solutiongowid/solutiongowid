...
export default function FnbLeadFormPage() {
          ...
          <div className="lead-form-grid">
            <div className="lead-form-hero">
              ...
              <div className="report-subtitle">
                고위드 분석 · 345개 식품 공급 기업<br className="desktop-br"/>34,613건 본사-가맹점 거래 데이터 분석
              </div>

              <div className="lead-form-cover-wrapper">
                <Image
                  src="/lead-form-fnb-cover.png"
                  alt="외식 프랜차이즈 수익구조 리포트"
                  width={600}
                  height={450}
                  priority
              ...
              <ul className="lead-form-bullets">
                <li>
                  ...
                  <span>345개 식품 공급 기업 · 34,613건 본사-가맹점 거래 데이터 분석</span>
                </li>
                <li>
                  <span className="lead-form-bullet-check">✓</span>
                  <span>본사 수익의 61.5%가 차액가맹금 채널에 집중된 취약 구조</span>
                </li>
                <li>
                  <span className="lead-form-bullet-check">✓</span>
                  <span>차액가맹금 환급 이후 수익 재설계 우선순위 진단</span>
                </li>
              </ul>
            </div>
