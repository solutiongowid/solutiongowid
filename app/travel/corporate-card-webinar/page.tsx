...
export default function CorporateCardWebinarTravelPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('/api/corporate-card-webinar-submit', {
        ...
        body: JSON.stringify({ ...formData, webinar_type: 'travel', timestamp: formattedTimestamp, ...utmParams }),
      });
  ...
  const accentColor = '#2A8B95';
  const accentLight = 'rgba(42, 139, 149, 0.08)';
  const accentBorder = 'rgba(42, 139, 149, 0.18)';
  ...
  return (
    <>
      <div className="report-page" style={{ background: '#ffffff', color: '#222' }}>
        ...
        {/* 히어로 섹션 */}
        <header className="report-header" style={{ background: 'linear-gradient(180deg, #eef7f8 0%, #ffffff 100%)', padding: '8rem 0 5rem' }}>
          <div className="report-container">
            <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
              <div style={{ marginBottom: '1.5rem' }}>
                <span className="badge" style={{ fontSize: '0.875rem', padding: '0.5rem 1.25rem', background: accentLight, color: accentColor, border: `1px solid ${accentBorder}` }}>5월 21일 (목) 오후 4시 | 온라인 웨비나</span>
              </div>
              <h1 className="report-h1" style={{ textAlign: 'center', marginBottom: '1.5rem', color: '#111' }}>
                <strong>
                  2026 법인카드 —<br />여기까지 왔습니다<br />: 여행편
                </strong>
              </h1>
              ...
              <div style={{ maxWidth: '600px', margin: '0 auto' }}>
                <Image
                  src="/corporate-card-webinar-travel-thumbnail.png"
                  alt="2026 법인카드 — 여기까지 왔습니다 : 여행편 - GoWid 웨비나"
                  width={1200}
                  height={630}
                  priority
        ...
        {/* 행사 소개 */}
        <section className="report-section" style={{ background: '#f1f8f9', padding: '5rem 0' }}>
          <div className="report-container">
            <div style={{ maxWidth: '720px', margin: '0 auto', textAlign: 'center' }}>
              ...
              <p style={{ fontSize: '1.0625rem', color: '#333', lineHeight: '1.9', marginBottom: '1.5rem' }}>
                법인카드를 바꾸기로 결정한 여행업 대표들한테<br className="mobile-only-br" /> 나중에 물어보면,<br />
              ...
              <p style={{ fontSize: '1.0625rem', color: '#333', lineHeight: '1.9', marginBottom: '1.5rem' }}>
                성수기 항공·숙박 하드블럭 선매입,<br />4~6개월 보유하는 선수금,<br />항공·호텔 외상 30~60일과 외화 결제 —<br />
                어떤 조건에서 바꾸는 게 맞고,<br />
                어떤 조건에서는 지금 그대로여도 되는지.
              </p>
              <p style={{ fontSize: '1.0625rem', color: '#333', lineHeight: '1.9' }}>
                <strong>여행업 활성 법인 데이터 기반으로 그 기준을 40분 안에 다룹니다.</strong>
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="report-container">
            <div style={{ maxWidth: '720px', margin: '0 auto', textAlign: 'center' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', maxWidth: '640px', margin: '0 auto', textAlign: 'left' }}>
                {[
                  '같은 매출 50억 패키지 여행사인데 법인카드 한도가 3배 차이 나는 이유',
                  'Q3 성수기 매출이 한 분기에 몰릴 때 자금 회전을 받쳐주는 결제 방식',
                  '선수금 4~6개월을 운영자금 압박 없이 보유하는 카드 조합',
                  '비슷한 규모의 여행 브랜드들이 돈을 실제로 어디에 쓰고 있는지',
                ].map((text, i) => (
        ...
        {/* 이런 분들께 추천합니다 */}
        <section className="report-section" style={{ background: '#f1f8f9' }}>
          <div className="report-container">
            <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', maxWidth: '600px', margin: '0 auto' }}>
                {[
                  <><strong>Q3 성수기 한 분기에 매출이 몰리는데 한도는 1년 내내 똑같은</strong> 패키지 여행사·OTA 대표</>,
                  <>한도 견적 받아봤지만 <strong>하드블럭 한 시즌도 못 받쳐서</strong> 그대로 둔 분</>,
                  <><strong>선수금이 4~6개월 보유되는데 운영자금은 늘 빡빡한</strong> 재무팀</>,
                  <>카드를 바꿔야 한다는 건 알지만 <strong>&ldquo;지금 굳이?&rdquo;로 미뤄온</strong> 여행업 대표</>,
              ...
              <button onClick={openModal} className="report-button-primary" style={{ marginTop: '2.5rem', background: accentColor, color: '#fff', boxShadow: '0 4px 20px rgba(42, 139, 149, 0.25)' }}>
                무료 웨비나 신청하기
              </button>
            </div>
          </div>
              ...
              <div className="cosmetic-timetable-pc" style={{ marginBottom: '3rem' }}>
                ...
                {[
                  { time: '00:00 ~ 00:03', title: '오프닝', speaker: '문미성 리드 · 고위드' },
                  {
                    ...
                    details: ['같은 매출 50억 패키지 여행사인데 한도가 3배 차이 나는 두 회사 — 뭐가 다른가', '한도 산정·시즌 변동·외화 결제 — 3년 사이 시장이 벌려놓은 격차', '여행업 N개사 데이터로 본 법인카드 이용 트렌드'],
                  ...
                  },
                  {
                    ...
                    details: ['Q3 성수기 매출 집중과 그 외 분기 자금 부족 — 시즌 변동성이 만드는 운전자본 묶임', '선수금 4~6개월 보유 vs 항공·호텔 외상 30~60일 — 미이행 의무가 운영자금을 갉아먹는 구조', '외화 결제 비중 30~70% × 환율 변동 — 분기마다 마진을 결정하는 변수'],
                    highlight: 'OTA 의존도 70%+ × 수수료 8~15% — 매출이 늘어도 마진이 따라가지 못하는 이유',
                  },
                  {
                    time: '00:25 ~ 00:32', session: 'Session 03', title: '세 가지 사례로 보는 — 같은 매출, 다른 현금흐름', speakerName: '김병권 BD', speakerCompany: '고위드',
                    details: ['시즌 변동에 한도가 따라가지 못했던 브랜드 — 시즌 한시 한도 증액으로 성수기 매입 자금 압박 해소, 매입액 14배 이상', '선수금이 부채로 묶여 있던 브랜드 — 외상 결제 카드 전환으로 결제 사이클 87일까지, 출발 시점 매출 회수와 정렬', '외화 결제 환차손과 OTA 수수료가 마진을 갉아먹던 브랜드 — 외화 결제 별도 한도 분리로 분기 환율 변동에도 운영자금 안정'],
          ...
          <div className="report-container">
            <div style={{ maxWidth: '640px', margin: '0 auto' }}>
              ...
              {[
                ...
                { q: '어떤 업종에 적합한 웨비나인가요?', a: '패키지 여행사·OTA를 중심으로 구성했지만, 시즌 변동·선수금·외화 결제·OTA 수수료 등 여행업의 현금 흐름 이슈가 있다면 카테고리 불문하고 도움이 됩니다.' },
        ...
        {/* 최종 CTA */}
        <section className="report-section report-section-cta" style={{ background: '#eef7f8', textAlign: 'center' }}>
          <div className="report-container">
            <div className="report-cta-content">
              <h3 className="report-h3" style={{ color: '#111' }}>
                <strong>바꿀 타이밍인지,<br />40분이면 답이 나옵니다.</strong>
              </h3>
              <button onClick={openModal} className="report-button-cta" style={{ background: accentColor, color: '#fff', boxShadow: '0 4px 20px rgba(42, 139, 149, 0.25)' }}>
                무료 웨비나 신청하기
              </button>
            </div>
          </div>
        ...
        {/* 푸터 */}
        <footer className="report-footer" style={{ background: '#f1f8f9', borderTop: '1px solid #e0e0e0' }}>
          <div className="report-container">
            ...
            {isSuccess ? (
              ...
              <>
                <div className="modal-header">
                  ...
                  <p className="modal-description">5월 21일(목) 오후 4시 | 2026 법인카드 — 여기까지 왔습니다 : 여행편</p>
                </div>
