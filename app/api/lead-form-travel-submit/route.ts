...
const ZAPIER_TRAVEL_HOOK_URL = 'https://hooks.zapier.com/hooks/catch/10485854/4bj8vwx/';
...
export async function POST(request: NextRequest) {
  try {
      ...
      .insert([
        {
          ...
          email,
          phone_number: phone,
          lead_source: utm_source || 'lead-form-travel',
          lead_source_detail: utm_medium || null,
          campaign: 'travel-lead-form',
    ...
    console.error('Error in lead-form-travel-submit API:', error);
    return NextResponse.json(
      { error: '서버 오류가 발생했습니다.' },
      { status: 500 }
    );
