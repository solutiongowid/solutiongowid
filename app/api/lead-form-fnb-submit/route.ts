...
const ZAPIER_FNB_HOOK_URL = 'https://hooks.zapier.com/hooks/catch/10485854/43ec8bz/';
...
export async function POST(request: NextRequest) {
  try {
      ...
      .insert([
        {
          ...
          email,
          phone_number: phone,
          lead_source: utm_source || 'lead-form-fnb',
          lead_source_detail: utm_medium || null,
          campaign: 'fnb-lead-form',
    ...
    await fetch(ZAPIER_FNB_HOOK_URL, {
      method: 'POST',
    ...
    console.error('Error in lead-form-fnb-submit API:', error);
    return NextResponse.json(
      { error: '서버 오류가 발생했습니다.' },
      { status: 500 }
    );
