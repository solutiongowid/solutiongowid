  ...
  try {
      ...
      .insert([
        {
          ...
          email,
          phone_number: phone,
          lead_source: utm_source || 'lead-form-ai-saas',
          lead_source_detail: utm_medium || null,
          campaign: 'ai-saas-lead-form',
    ...
    await fetch(ZAPIER_WEBHOOK_URL, {
      ...
      body: JSON.stringify({
        ...
        landing_page: 'lead-form-ai-saas',
        timestamp,
      }),
    ...
    console.error('Error in lead-form-ai-saas-submit API:', error);
    return NextResponse.json(
      { error: '서버 오류가 발생했습니다.' },
      { status: 500 }
    );
