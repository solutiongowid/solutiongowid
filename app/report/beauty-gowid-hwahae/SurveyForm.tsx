...
export default function SurveyForm({ isOpen, onClose, utmParams }: SurveyFormProps) {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('/api/survey-submit-beauty-hwahae', {
        method: 'POST',
        headers: {
  ...
  const handleDownload = () => {
    window.open('https://drive.google.com/file/d/1UzjTnvJGnbc3Be1TcXeosWcD7mdUKKNZ/view?usp=sharing', '_blank');
  };
