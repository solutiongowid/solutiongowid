            ...
            <div className="report-feature-content">
              ...
              <div className="report-feature-description">
                ...
                <p>
                  ...
                  원가 -27pp, 물류비 -0.7pp. 비용을 줄인 게 아니라 구조를 바꾼 결과입니다.
                </p>
                <p>
                  같은 매출에서 출발해도 결과는 정반대였습니다.<br/>
                  성공 기업의 원가 -32pp vs 실패 기업의 원가 +28pp — 격차 53pp.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="report-feature-content">
              ...
              <div className="report-feature-description">
                <p>
                  ...
                  물류비를 1.4%로 만드는 법 — 파스토 풀필먼트가 이커머스의 물류 효율화 레버를 실현합니다.
                </p>
                <p>
                ...
                <p>
                  비용 구조를 모르면 계곡이 보이지 않습니다.<br/>
                  고위드 법인카드로 원가·물류·수수료·광고비를 실시간으로 측정하세요.
                </p>
              </div>
            </div>
          </div>
