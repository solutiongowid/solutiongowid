...
export default function SurveyForm({ isOpen, onClose, utmParams }: SurveyFormProps) {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('/api/survey-submit-tech-decision-2026', {
        method: 'POST',
        headers: {
      ...
      router.push('/report/tech-decision-2026/thank-you');
