...
export default function ManufacturingThankYouPage() {
  useEffect(() => {
    if (typeof window.fbq === 'function') {
      window.fbq('track', 'Lead', {
        content_name: 'report-manufacturing',
        content_category: 'manufacturing-report',
      });
    }
  }, []);
        ...
        <div className="report-container">
          <div className="thank-you-content">
            ...
            <div className="thank-you-cta-group">
              <Link href="/report/manufacturing" className="thank-you-cta-secondary">
                닫기
              </Link>
            </div>
          </div>
