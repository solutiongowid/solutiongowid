          ...
          <div className="report-header-content">
            <div className="report-header-text-wrapper">
              ...
              <div className="report-subtitle">
                혁신의숲 X 고위드,<br/>
                196개 AI·머신러닝 기업의 지출 데이터에서 답을 찾다
              </div>
              <button
                onClick={openModal}
            ...
            <div className="report-recommendation-left">
              ...
              <div className="report-recommendation-list">
                <div className="report-recommendation-item">
                  ...
                  <div>비용 대비 매출 비율(BM)을 개선하고 싶은 AI 스타트업 대표</div>
                </div>
                <div className="report-recommendation-item">
        ...
        <div className="report-container">
          <div className="report-feature-content">
            ...
            <div className="report-feature-description">
              ...
              <p>
                그 차이가 어디서 오는지, 어떤 순서로 움직여야 하는지를 196개 AI·머신러닝 기업의 실제 데이터로 정리했습니다.
              </p>
              <p>
                BM을 어떻게 통제해야 할지, 런웨이를 어떻게 확보해야 할지 오늘도 현장에서 치열하게 고민하고 계신 AI 스타트업 대표님께 이 리포트가 판단의 기준이 되길 바랍니다.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="report-container">
          <div className="report-cta-content">
            <h3 className="report-h3">
              <strong>AI·머신러닝 기업의 성장 기준,<br/>지금 바로 확인하세요</strong>
            </h3>
            <button
              onClick={openModal}
