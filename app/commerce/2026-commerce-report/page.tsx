          ...
          <div className="report-container">
            <div className="report-feature-content">
              ...
              <div className="report-feature-description">
                <p>
                  고위드는 3천 개 이상의 스타트업과 함께하며<br/>
                  법인카드와 지출관리 서비스를 제공하고 있습니다.
                </p>
                <p>
                  이 과정에서<br/>
                  광고비가 언제 집행되어 매출 회수까지 얼마나 걸리는지,<br/>
                  매출 규모마다 공헌이익이 어떻게 변하는지,<br/>
                  인원이 늘 때 재무 구조가 어떻게 달라지는지를 직접 확인해왔습니다.
                </p>
                <p>
                  성장한 기업과 쇠퇴한 기업을 가른 건<br/>
                  매출 규모가 아니었습니다.<br/>
                  효율성이었습니다.
                </p>
                <p>
                  같은 투자를 해도 누군가는 성장하고,<br/>
                  누군가는 적자가 커집니다.
                </p>
                <p>
                  그 차이가 어디서 오는지,<br/>
                  어떤 순서로 움직여야 하는지를 데이터 기반으로 정리했습니다.
                </p>
                <p>
                  어디에 투자를 해야할지, 무엇을 먼저 고치는 게 좋을지<br/>
                  오늘도 현장에서 치열하게 고민하고 계신 커머스 기업의 대표님께<br/>
                  이 리포트가 판단의 기준이 되길 바랍니다.
                </p>
              </div>
            </div>
          </div>
