...
export const CHATBOT_RESPONSES: Record<string, ChatResponse> = {
  ...
  howto_limit: { text: "담당자가 직접 연락드려요.", video: '/cta-video.mp4', textAfterVideo: "예상 한도, 페이백, 같은 업종 사례까지 정리해서 가져갈게요.", options: [], isFinal: true, finalType: "apply", link: "https://gowid.com/card-apply-lead/?utm_source=facebook&utm_medium=paid-display&utm_campaign=commerce-apply-lead-04" },
  howto_internal: { text: "내부 공유용 비교 자료를 정리해서 설명드릴 수 있어요.\n설득에 필요한 숫자를 맞춰드릴게요.", options: END_OPTIONS },

  cta_apply: { text: "담당자가 직접 연락드려요.", video: '/cta-video.mp4', textAfterVideo: "예상 한도, 페이백, 같은 업종 사례까지 정리해서 가져갈게요.", options: [], isFinal: true, finalType: "apply", link: "https://gowid.com/card-apply-lead/?utm_source=facebook&utm_medium=paid-display&utm_campaign=commerce-apply-lead-04" },
